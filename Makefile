...
K8S_TEST_IMAGE_TO_TEST ?= artefact.skao.int/ska-ser-skallop:2.9.1 --overrides='{"spec": { serviceAccountName: "ci-svc-${CI_PROJECT_NAME}-${CI_JOB_ID}" } }'## docker image that will be run for testing purpose
