...
## HOOKS: none
## VARS: none
##  make target for running the ska-tango-examples -specific tests in the Skampi CI pipeline

skampi-test-04tangoexamples:  ## launcher for ska-tango-examples tests
