...
from resources.test_support.controls import set_telescope_to_standby, set_telescope_to_running, telescope_is_in_standby, \
    take_subarray
...
def allocate_four_dishes(result):
    ...
    ##############################
    @log_it('AT2-577_PUB_SUB', devices_to_log, non_default_states_to_check)
...
@then("resources are successfully assigned")
