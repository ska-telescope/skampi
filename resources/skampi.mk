...
skampi-test-03sdp:  ## launcher for SDP tests
	...
	telescope=$$(echo $(DEPLOYMENT_CONFIGURATION) | sed s/-/_/ | sed s/ska/SKA/); \
	make skampi-k8s-test-component K8S_TEST_IMAGE_TO_TEST=registry.gitlab.com/ska-telescope/sdp/ska-sdp-integration/ska-sdp-integration-tests:$$version MARK="$$telescope and acceptance"
