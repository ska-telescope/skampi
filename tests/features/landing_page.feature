...
Feature: Landing Page Availability and link generation
	...
	@XTP-3900 @XTP-3901 @XTP-3324
	Scenario Outline: Test Landing Page Navigability on ska mid
		Given a deployed ska-mid
