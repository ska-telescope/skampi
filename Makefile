...
k8s-pre-install-chart:
	...
	helm repo add ska-tango-images https://artefact.skao.int/repository/helm-internal && \
	helm upgrade --install tango-base0 \
	$(K8S_CHART_PARAMS) ska-tango-images/ska-tango-base --namespace $(KUBE_NAMESPACE) --version 0.4.1 && \
