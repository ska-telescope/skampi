...
OCI_BUILD_ADDITIONAL_ARGS = "--build-arg\ SKA_PYTHON_PYTANGO_RUNTIME_ALPINE_IMAGE=${SKA_PYTHON_PYTANGO_RUNTIME_ALPINE_IMAGE}\ --build-arg\ SKA_K8S_TOOLS_BUILD_DEPLOY_ALPINE=${SKA_K8S_TOOLS_BUILD_DEPLOY_ALPINE}"
