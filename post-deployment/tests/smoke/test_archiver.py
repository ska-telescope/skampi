...
def test_mid_archiver():
  ...
  attribute = f"tango://{mvp_tango_host}:10000/ska_mid/tm_leaf_node/sdp_subarray01/State"
...
def test_low_archiver():
  ...
  event_subscriber = \
    f'tango://{mvp_tango_host}:10000/archiving/hdbpp/eventsubscriber01'
  attribute = f"tango://{mvp_tango_host}:10000/ska_low/tm_leaf_node/mccs_subarray01/State"
