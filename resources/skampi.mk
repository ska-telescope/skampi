...
skampi-test-03sdp:  ## launcher for SDP tests
	...
	make skampi-k8s-test-component K8S_TEST_IMAGE_TO_TEST="artefact.skao.int/ska-sdp-integration-tests:0.9.2-dirty --overrides='{\"spec\": { \"serviceAccountName\": \"ci-svc-${CI_PROJECT_NAME}-${CI_JOB_ID}-mid-k8s\" } }'" MARK="SKA_mid and acceptance"
