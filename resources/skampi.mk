...
#	make skampi-k8s-test-component K8S_TEST_IMAGE_TO_TEST=artefact.skao.int/ska-sdp-integration-tests:$$version MARK="$$telescope and acceptance"
	make skampi-k8s-test-component K8S_TEST_IMAGE_TO_TEST="registry.gitlab.com/ska-telescope/sdp/ska-sdp-integration/ska-sdp-integration-tests:0.9.1-dev.cd6d1f00a --overrides='{\"spec\": { \"serviceAccountName\": \"ci-svc-${CI_PROJECT_NAME}-${CI_JOB_ID}\" } }'" MARK="SKA_mid and acceptance"
