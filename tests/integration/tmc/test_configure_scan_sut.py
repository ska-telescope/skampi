...
@pytest.mark.skalow
@scenario(
    "features/tmc_configure_scan_sut.feature", "Configure for a scan on a subarray - happy flow"
)
...
@then(parsers.parse("the {scan_type} is correctly configured on the subarray {subarray_id}"))
