...
@given("the SKA Jira project for Solution and System Acceptance Tests (skampi tests) with project key XTP", target_fixture="unreleased_fixversion")
...
def check_if_fix_version_matches(local_version: str, unreleased_fixversion: str):
    ...
    """
    assert local_version == unreleased_fixversion, f"{local_version} in test-exec.json; earliest unreleased version in Jira: {unreleased_fixversion}"
