...
install: k8s-clean k8s-namespace namespace-sdp k8s-install-chart k8s-wait## install the helm chart on the namespace KUBE_NAMESPACE and wait for completion of jobs 
