...
class TMLow(_NameBase):
    ...
    def __init__(self, tag) -> None:
        ...
        self.mccs_leaf_node = DeviceName(
            self._name("leaf_node/mccs_master"),
            *{"master domain", "leaf nodes", "mccs control", *self.tags},
        )
...
def _low_masters() -> List[DeviceName]:
    return [Low.tm.central_node, Low.sdp.master, Low.csp.controller, Low.tm.csp_leaf_node]
