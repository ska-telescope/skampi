...
@when(parsers.parse("I configure the subarray again for scan type {scan_type}"), target_fixture="configured_subarray",)
@given(parsers.parse("a subarray configured for scan type {scan_type}"), target_fixture="configured_subarray",)
