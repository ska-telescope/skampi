...
const kibanaURL = 'http://logging.skao.stfc:5601/app/logs/stream?'+
...
const TMCDashboardURL =`https://k8s.stfc.skao.int/${NAMESPACE}/taranta/dashboard?id=62ff59f4f937c9001852a142&mode=run`
