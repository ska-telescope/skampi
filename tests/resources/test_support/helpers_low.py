...
class waiter:
    ...
    def set_wait_for_ending_SB(self):
        ...
        self.waits.append(
            watch(resource("low-mccs/subarray/01")).to_become(
                "obsState", changed_to="IDLE"
            )
        )
    ...
    def set_wait_for_assign_resources(self):
        ...
        self.waits.append(
            watch(resource("low-mccs/control/control")).to_become(
                "State", changed_to="ON"
            )
        )
        self.waits.append(
            watch(resource("low-mccs/subarray/01")).to_become("State", changed_to="ON")
        )
        self.waits.append(
            watch(resource("low-mccs/subarray/01")).to_become(
                "obsState", changed_to="IDLE"
    ...
    def set_wait_for_going_to_standby(self):
        ...
        self.waits.append(
            watch(resource("ska_low/tm_central/central_node")).to_become(
                "State", changed_to="OFF"
            )
        )
