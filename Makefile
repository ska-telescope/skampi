...
helm-pre-build:
	helm repo add --username gitlab-ci-token --password $$CI_JOB_TOKEN  ska-sdp-dev https://gitlab.com/ska-telescope/api/v4/projects/21141217/packages/helm/ska-sdp
	helm repo update
